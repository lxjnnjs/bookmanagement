...
<div class="container-fluid">
	...
	<div class="row-fluid">
		<div class="col-xs-3 span3" align="center">
			 <button class="btn btn-large btn-block" type="button"><a href="readermodifi.php">管理读者信息</a></button>
		</div>
		<div class="col-xs-3 span3" align="center">
			<button class="btn btn-large btn-block" type="button"><a href="bookmodifi.php">管理图书信息</a></button>
		</div>
		<div class="col-xs-3 span3" align="center">
			<button class="btn btn-large btn-block" type="button"><a href="borrowmodifi.php">管理借阅信息</a></button>
		</div>
	</div>
	<div class="row-fluid">
		<div class="span12">
