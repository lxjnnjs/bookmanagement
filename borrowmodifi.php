...
<div class="container-fluid">
	...
	<form  action="manager5-connect.php" method="post" style='text-align:center'>
    <p align="center"><label >图书编号：</label><input type="text" name="BNO" class="xiaobiankuang"></p>
    <p align="center"><label>馆藏量&nbsp;：</label><input type="text" name="GCL" class="xiaobiankuang"></p>
	<p align="center"><label>库存量&nbsp;：</label><input type="text" name="KCL" class="xiaobiankuang"></p>
	<p align="center"><label>借阅期限：</label><input type="text" name="TLIMIT" class="xiaobiankuang"></p>
	<button type:"submit" >增加该图书借阅信息</button>
	</form>
	<form  action="manager6-connect.php" method="post" style='text-align:center'>
	<p align="center"><label >图书编号：</label><input type="text" name="BNO" class="xiaobiankuang"></p>
	<button type:"submit" >删除该图书借阅信息</button>
	</form>
	<div class="row-fluid">
		<div class="span12">
